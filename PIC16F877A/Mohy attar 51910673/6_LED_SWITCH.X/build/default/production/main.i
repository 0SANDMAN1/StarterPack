...
void main() {
    ...
    while(1){
        if (RB0 == 0)
        {
            ...
            switch (button){
            case 1: PORTB = 0x01; RB1 = 1; _delay((unsigned long)((3000)*(40000000/4000.0))); PORTB = 0x01; button = 0; break;
            case 2: PORTB = 0x01; RB3 = 1; RB6 = 1; _delay((unsigned long)((3000)*(40000000/4000.0))); PORTB = 0x01; button = 0; break;
            case 3: PORTB = 0x01; RB3 = 1; RB6 = 1; RB1 = 1; _delay((unsigned long)((3000)*(40000000/4000.0))); PORTB = 0x01; button = 0; break;
            case 4: PORTB = 0x01; RB2 = 1; RB5 = 1; RB4 = 1; RB7 = 1; _delay((unsigned long)((3000)*(40000000/4000.0))); PORTB = 0x01; button = 0; break;
            case 5: PORTB = 0x01; RB2 = 1; RB5 = 1; RB4 = 1; RB7 = 1; RB1 = 1; _delay((unsigned long)((3000)*(40000000/4000.0))); PORTB = 0x01; button = 0; break;
            case 6: PORTB = 0x01; RB2 = 1; RB3 = 1; RB4 = 1; RB5 = 1; RB6 = 1; RB7 = 1; _delay((unsigned long)((3000)*(40000000/4000.0))); PORTB = 0x01; button = 0; break;
        }
        }
    }
}
